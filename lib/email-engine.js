...
const NON_ORIGINAL_DROP_HEADERS = new Set(['delivered-to','x-received','return-path','received-spf','authentication-results','dkim-signature']);
...
function isNoisyHeadersOnlyHeader(name) { return isRemovedOutsideOriginal(name) || HEADERS_ONLY_DROP_HEADERS.has(name); }
