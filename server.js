...
app.get('/api/health', (req, res) => res.json({ ok: true, service: 'email-extraction-cmh9', version: '5.9.0', rememberAvailable: REMEMBER_AVAILABLE }));
...
if (require.main === module) app.listen(PORT, '0.0.0.0', () => console.log(`Email Extraction CMH9 v5.9.0 running on http://0.0.0.0:${PORT}`));
module.exports = app;
